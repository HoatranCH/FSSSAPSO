...
% figure;
% figure;
% plotdisp(Nodes,Elements,Types,DOF,phi(:,9),'DispMax','off')
% 
% plotdisp(Nodes,Elements,Types,DOF,phi(:,5),'DispMax','off')
% figure;
% plotdisp(Nodes,Elements,Types,DOF,phi(:,6),'DispMax','off')
% figure;
% plotdisp(Nodes,Elements,Types,DOF,phi(:,7),'DispMax','off')
% figure;
